# DivyanshGoenka_Tutedude_Python_Assignments_1

This repository contains the Python Assignment no. 1 completed by Divyansh Goenka for the Tutedude Python course.
...
2. **Navigate to the Directory:**
   ```bash
   cd DivyanshGoenka_Tutedude_Python_Assignment_2/assignment_two
   ```
